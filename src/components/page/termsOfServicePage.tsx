  ...
  return (
    <div className="container mx-auto max-w-2xl px-4 py-8">
      ...
      <section className="mb-8">
        <h2 className="text-xl sm:text-2xl font-semibold mb-4">第1条（利用者の定義）</h2>
        <p>
      ...
      <section className="mb-8">
        <h2 className="text-xl sm:text-2xl font-semibold mb-4">第2条（利用契約の成立）</h2>
        <p>
      ...
      <section className="mb-8">
        <h2 className="text-xl sm:text-2xl font-semibold mb-4">第3条（禁止事項）</h2>
        <p>
      ...
      <section className="mb-8">
        <h2 className="text-xl sm:text-2xl font-semibold mb-4">第4条（免責事項）</h2>
        <p>
      ...
      <section className="mb-8">
        <h2 className="text-xl sm:text-2xl font-semibold mb-4">第5条（利用規約の変更）</h2>
        <p>
      ...
      <section className="mb-8">
        <h2 className="text-xl sm:text-2xl font-semibold mb-4">第6条（準拠法・裁判管轄）</h2>
        <p>
