  ...
  return (
    <div className="container mx-auto max-w-2xl px-4 py-8">
      ...
      <section className="mb-8">
        ...
        <p>当サイトおよび関連するツール・サービスでは、各種お問い合わせ、サービスの利用登録、求人応募に関する連絡、業務依頼などの際に、名前やメールアドレス等の個人情報をご提供いただく場合があります。これらの情報は、適切なサービス提供、お問い合わせ対応、就職活動関連の連絡、業務連絡などの目的で利用させていただきます。</p>
      </section>
      ...
      <section>
        ...
        <p>当サイトの個人情報の取扱い、免責事項に関するお問い合わせ、ツールの使用に関する質問、求人応募に関するご連絡、業務依頼など、あらゆるお問い合わせについては、以下のContactページからご連絡ください。迅速かつ適切に対応させていただきます。</p>
